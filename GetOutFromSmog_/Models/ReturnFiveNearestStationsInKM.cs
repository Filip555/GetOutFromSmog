...
namespace GetOutFromSmog_.Models
{
    ...
    {
        public List<ParseJsonToList> ReturnNearestStation(List<ParseJsonToList> model, double userLatitudes, double userLongitudes, float range)
        {
            ...
            var filtredModel = model.Where(x =>
            {
                ...
                return (distanceInKmFromUserToStation < range);
            }).ToList();
            return filtredModel;
        }
